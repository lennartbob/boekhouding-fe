...
<template>
  <div class="flex flex-col h-screen w-64 bg-gray-800 text-white">
    <!-- 1) Organization Logo and Name (from Sidebar.vue) -->
    ...
    <div class="flex-1 overflow-y-auto">
        <nav class="p-4 space-y-2">
            <!-- Static Links (from AppSidebar.vue) -->
            ...
            <!-- Dynamic Rekeningen List (from AppSidebar.vue) -->
    ...
    <!-- 3) User Profile Component at the bottom (from Sidebar.vue) -->
    <div class="p-4 border-t border-gray-700 flex-shrink-0">
        <UserProfile />
    </div>
  </div>

  <!-- Modal for Adding a New Rekening (from AppSidebar.vue) -->
